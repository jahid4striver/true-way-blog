...
const Navbar = () => {
    return (
        <div className="navbar bg-dark-purple shadow-md shadow-gray-200 text-orange-300 rounded-xl">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        <li className='hover:bg-light-white'><Link to="/">Home</Link></li>
                ...
                <Link to="/" className="btn btn-ghost normal-case text-2xl">True Way Blog</Link>
            </div>
